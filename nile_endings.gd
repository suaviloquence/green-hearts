...
var bad_ending_5 = DialogNode.new("He walks away as the ocean tide gets higher and higher. The lifeguard on the beach is yelling in her megaphone to run, that something isn’t right. That this is unnatural.", bad_ending_6, RESET)
...
var bad_ending_start = DialogNode.new("Nile stands up, looking towards the ocean. He doesn’t look down at you at all. His tone is distant, and the playful warmth from earlier has vanished.", bad_ending_1, NILE)
...
var good_ending_start = DialogNode.new("Nile stands up, and then reaches a hand out to you. He pulls you into a warm embrace, voice soft.", good_ending_1, NILE)
