...
var three_hearts_start = DialogNode.new("Nile: Wow, this looks absolutely amazing. You said these ingredients are mostly sustainable?",
										three_hearts_1, preload("res://store/good scamp.png"))
...
var no_hearts_start = DialogNode.new("Nile: So… This doesn’t look that amazing if I’m going to be so real with you.", no_hearts_1, preload("res://store/bad scamp.png"))
