...
var three_hearts_final = DialogNode.new("Score!!!", null, null, func(player): add_heart(player, 3))
...
var three_hearts_start = DialogNode.new("Nile: Wow, this looks absolutely amazing. You said these ingredients are mostly sustainable?",
										three_hearts_1, preload("res://store/good scamp.png"), func(_p): explode("✨"))

var two_hearts_final = DialogNode.new("Nile: It tastes so good! I’m glad I could make this with you, you are swaying me to your side $name.", null, null, func(player): add_heart(player, 2))
...
var two_hearts_start = DialogNode.new("Nile: This looks good! Better than something I could cook on my own.", two_hearts_1, preload("res://store/good scamp.png"))

var one_hearts_final = DialogNode.new("Nile: It tastes good! I’m glad I could make this with you $name. But I’m going to be real with you, I think we could’ve made this 10x better if we weren’t watching out for sustainable food.", 
null, null, func(player): add_heart(player))
...
var one_hearts_start = DialogNode.new("Nile: This looks good! Better than something I could cook on my own.", one_hearts_1, preload("res://store/good scamp.png"))
...
var no_hearts_start = DialogNode.new("Nile: So… This doesn’t look that amazing if I’m going to be so real with you.", no_hearts_1, preload("res://store/bad scamp.png"), func(_p): explode("⁉️"))
...
$name: They’re beautiful, thank you so much Nile! I have the kitchen prepped, shame you wore such a nice outfit for a cooking date.", post_game_4, null, func(_p): explode("🪻"))
var post_game_2 = DialogNode.new("Nile: Hi $name! I got you flowers, I hope you like them!", post_game_3)
var post_game_1 = DialogNode.new("Nile is rocking on his heels a bit with his hands behind his back, looking all around your front porch.Once you open the door, he stumbles for a second before giving you a big, warm smile.", post_game_2, NILE)
...
func _ready() -> void:
	...
	if sustainability >= 8 and taste >= 2:
		post_game_final.following = three_hearts_start
	elif sustainability >= 4 and taste >= 1:
		post_game_final.following = two_hearts_start
	elif sustainability >= 1 and taste >= 0:
		post_game_final.following = one_hearts_start
	else:
		post_game_final.following = no_hearts_start
