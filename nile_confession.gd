...
var ultimatum_start = DialogNode.new("Nile frowns, a little shocked by your statement.
...
var try_start = DialogNode.new("Nile: I… I get it. I’ve never really thought about this stuff like you do, but I can see how much it means to you. If it’s that important to you, then yeah—I’ll try. I’m not making any promises to go zero waste tomorrow, but I’ll give it a shot.", null)
...
try_start, "I don’t expect you to change everything overnight. But I need to know that you’re willing to try.", ultimatum_start, "If you can’t make that change, then I don’t think I can continue this relationship")
