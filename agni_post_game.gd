...
var no_heart_start = DialogNode.new("Agni: . . . so is it normally that hard?", no_heart_1, AGNI)

var two_hearts_3 = DialogNode.new("Agni definitely seems more receptive to the idea of cleaning the environment than before.", null, null, func(player): add_heart(player, 2))
...
var two_hearts_start = DialogNode.new("Agni: Huh, that wasn’t that bad. Though you were kind of slow.", two_hearts_1, AGNI)

var three_hearts_2 = DialogNode.new("Agni looks at you in admiration, and looks back at the bins. They seem to like the idea that cleaning the environment isn’t hard!", null, null, func(player): add_heart(player, 3))
...
var three_hearts_start = DialogNode.new("Agni: That was really easy and fast, you’re really good at this.", three_hearts_1, AGNI)
