...
var bad_ending_7 = DialogNode.new("As you turn around, you see that in the direction Agni left in, fires consume the trees near you. And they keep moving towards you. You failed your mission.", bad_ending_final)
...
var bad_ending_start = DialogNode.new("Agni stands up in a hurry, and starts pacing a bit. You continue to sit, not knowing what to do.", bad_ending_1)
...
var good_ending_start = DialogNode.new("You both sit in silence. You don’t want to disrupt Agni’s thoughts, and Agni seems to want a minute to themselves.", good_ending_1)
